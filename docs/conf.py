...
project = "mjinx"
copyright = "2022 Ivan Domrachev, Simeon Nedelchev."
...
init_path = join(dirname(dirname(str(abspath(__file__)))))
with open(f"{init_path}/pyproject.toml") as fh:
    for line in fh:
        match = re.match('version = "((\\d+\\.\\d+)\\.\\d+)[a-z0-9\\-]*".*', line)
